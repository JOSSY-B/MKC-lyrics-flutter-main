...
class ChordsMain extends StatefulWidget {
  final String title;

  ChordsMain({Key? key, required this.title}) : super(key: key);

  @override
  _ChordsMainState createState() => _ChordsMainState();
}

class _ChordsMainState extends State<ChordsMain> {
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    return ListTile(
                      ...
                      subtitle: Text(
                          "${song.chord} ${song.rhythm} ${song.tempo} ",
                          style: const TextStyle(
                              fontSize: 20,
